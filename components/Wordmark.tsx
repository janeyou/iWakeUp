...
/**
 * AI Radar wordmark: Geist 400 italic, "AI" in accent purple, "RADAR" in --text,
...
export function Wordmark({ size = "md" }: { size?: "sm" | "md" | "lg" }) {
  ...
  return (
    <Link
      href="/"
      className="inline-flex items-center gap-2 font-[family-name:var(--font-display)] font-normal italic tracking-[-0.02em] leading-none"
      style={{ fontSize: px }}
    >
      <span>
